...
public static class PTG
{
	public static void Call()
	{
		...
		if (string.IsNullOrEmpty(Program.CustomLanguageName)) Program.CustomLanguageName = "LLC-zh_CN";
		...
		Program.LoadParatranzWroks(new DirectoryInfo(Program.ParaPath), Program.PtDic);
		...
		foreach (var ptKvs in Program.PtDic)
		{
